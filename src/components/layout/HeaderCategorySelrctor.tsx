...
const HeaderCategorySelrctor = async () => {
  ...
  return (
    <div className='relative inline-block'>
        ...
        <div className='absolute top-full left-0 pt-2 opacity-0 invisible peer-hover:opacity-100 peer-hover:visible hover:opacity-100 hover:visible transition-all duration'>
            <div className='w-64 bg-white rounded-lg shadow-xl border-b-gray-100 overflow-hidden'>
                <div className='py-2'>
...
export default HeaderCategorySelrctor